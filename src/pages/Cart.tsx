...
import ArrowBack from '../assets/img/back.png';
        ...
        cartItems.items.length ? (
          <div className="cart">
            <div className="cart__top">
              ...
              <div onClick={() => dispatch(onClearCart())} className="cart__clear">
          ...
          <>
            <button style={{backgroundColor: 'transparent', border: 'none'}} onClick={() => navigate(-1)}>
              <img style={{ width: 40, cursor: "pointer" }} src={ArrowBack} alt="back-arrow" />
            </button>
            <h2 style={{ textAlign: "center", marginBottom: "50px" }}>В корзине пусто 😥</h2>
